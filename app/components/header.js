...
export default function Headers() {
    ...
    return (
        <header className="flex flex-col">
            <div className="flex gap-6 mx-20 my-4 text-xs font-bold font-Archivo">
            ...
            <div className="">
                <nav className="flex items-center h-16 mx-20 bg-white rounded-md shadow-xl">
                        ...
                        />
                    <ul className="flex gap-2 pr-4 ml-auto font-bold font-Lexend">
                        <li><a>Forside</a></li>
                        <li><a>Om os</a></li>
                        <li><a>Events</a></li>
                        <li><a>Kontakt</a></li>
                    ...
                    <div id="cta" className="flex items-center justify-center w-40 h-16 font-bold text-white bg-blush rounded-r-md font-Lexend">
